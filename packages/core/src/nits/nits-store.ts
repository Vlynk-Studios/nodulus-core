...
export function initNitsRegistry(projectName: string): NitsRegistry {
  return {
    _note: 'This file is generated by Nodulus NITS. Include it in Git. / Este archivo es generado por Nodulus NITS. Incluirlo en Git.',
...
export async function saveNitsRegistry(registry: NitsRegistry, cwd: string): Promise<void> {
  ...
  // Ensure metadata and versioning instructions are current before persisting
  registry._note = 'This file is generated by Nodulus NITS. Include it in Git. / Este archivo es generado por Nodulus NITS. Incluirlo en Git.';
